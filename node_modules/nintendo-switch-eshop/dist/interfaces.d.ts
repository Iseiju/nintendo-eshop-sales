 ...
 */
export declare type AlgoliaResults = {
    hits: GameUS[];
    nbHits: number;
    page: number;
    nbPages: number;
 ...
 */
export declare type AlgoliaResponse = {
 ...
 */
export declare type PriceResponse = {
    error: PriceError;
 ...
 */
export declare type PriceError = {
    code: string;
    message: string;
};
/**
 ...
 */
export declare type USRequestOptions = {
 ...
 * @extends RequestOptions
 */
export declare type EURequestOptions = {
    locale?: string;
} & RequestOptions;
/**
