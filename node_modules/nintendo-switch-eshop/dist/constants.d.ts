...
export declare const US_GET_GAMES_OPTIONS: {
    system: string;
    sort: string;
    direction: string;
};
...
export declare const US_ALGOLIA_KEY = "9a20c93440cf63cf1a7008d75f7438bf";
...
export declare const US_PRICE_RANGES: string[];
...
export declare const JP_GET_GAMES_CURRENT = "https://www.nintendo.co.jp/data/software/xml-system/switch-onsale.xml";
/** URL for getting upcoming JP Games */
export declare const JP_GET_GAMES_COMING = "https://www.nintendo.co.jp/data/software/xml-system/switch-coming.xml";
...
export declare class EshopError extends Error {
    /**
