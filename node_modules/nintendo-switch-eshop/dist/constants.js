...
exports.US_GET_GAMES_OPTIONS = { system: 'platform:Nintendo Switch', sort: 'title', direction: 'asc' };
/** Algolia ID for getting US games */
exports.US_ALGOLIA_ID = 'U3B6GR4UA3';
/** Algolia Key for getting US games */
exports.US_ALGOLIA_KEY = '9a20c93440cf63cf1a7008d75f7438bf';
...
exports.US_GAME_LIST_LIMIT = 200;
/** Price ranges for US games */
exports.US_PRICE_RANGES = [
    'Free to start',
    '$0 - $4.99',
    '$5 - $9.99',
    '$10 - $19.99',
...
exports.EU_GAME_LIST_LIMIT = 9999;
/** URL for getting currently released JP Games */
exports.JP_GET_GAMES_CURRENT = 'https://www.nintendo.co.jp/data/software/xml-system/switch-onsale.xml';
/** URL for getting upcoming JP Games */
exports.JP_GET_GAMES_COMING = 'https://www.nintendo.co.jp/data/software/xml-system/switch-coming.xml';
